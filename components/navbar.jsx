...
export const Navbar = () => {
  ...
  return (
    ...
    <div className="sticky top-0 z-50 lg:mx-0 border-b " id="navBar">
      <div className="max-w-screen-2xl mx-auto py-5 flex justify-between items-center  " >
        ...
        <div className="flex items-center gap-5 md:gap-16">
          ...
          <div className="hidden md:flex gap-10">
            <Link href="/home" className={`font-medium hover:text-[#008CFF] text-lg ${pathname === "/service" ? "text-[#008CFF]" : "text-gray-600"}`}>Service</Link>
            <Link href="/features" className={`font-medium hover:text-[#008CFF] text-lg ${pathname === "/features" ? "text-[#008CFF]" : "text-gray-600"}`}>Products</Link>
        ...
        <Link href="/sales" className={`font-medium flex items-center ${pathname === "/sales" ? "text-[#ffffff]" : "text-white"}`}><Button className="bg-[#008CFF] hover:bg-[#0077ff] px-6 py-2">
